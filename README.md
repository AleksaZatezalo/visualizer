# Visualizer
This software is a basic network visualizer built using the SDL2 package in C. The network is meant to portray a neural net and looks like a basic programing graph.

A guide on how to code the network visualizer can be found in this YouTube Video below.

[![Watch the video](https://img.youtube.com/vi/O4PNEg1ty1c/maxresdefault.jpg)](https://youtu.be/O4PNEg1ty1c)
